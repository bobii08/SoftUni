namespace _07.SortedSubsetSums
{
    ...
    internal class SortedSubsetSums
    {
        ...
        private static void Main()
        {
            ...
            for (int numberOfElements = 1; numberOfElements <= nums.Length; numberOfElements++)
            {
                ...
                var orderedListOfLists = listOfLists.OrderBy(a => a[0]);
                foreach (var currentList in orderedListOfLists)
                {
                    Console.WriteLine(string.Join(" + ", currentList) + " = " + sum);
                }
            }
        }
    }

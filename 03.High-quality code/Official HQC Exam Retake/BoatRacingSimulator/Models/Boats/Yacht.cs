namespace BoatRacingSimulator.Models.Boats
{
    ...
    public class Yacht : MotorBoat
    {
        ...
        public int CargoWeight
        {
            ...
            private set
            {
                Validator.ValidatePositivePropertyValue(value, "Cargo Weight");
        ...
        {
            return this.FirstBoatEngine.Output - (this.Weight + this.CargoWeight) + ((double)race.OceanCurrentSpeed / 2);
        }
    }
}
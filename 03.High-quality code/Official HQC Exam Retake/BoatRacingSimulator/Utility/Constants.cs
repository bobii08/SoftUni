namespace BoatRacingSimulator.Utility
{
    public static class Constants
    {
        ...
        public const string IncorrectPositivePropertyValueMessage = "{0} must be a positive integer.";
        ...
        public const int SailBoatMinEfficiency = 1;

        public const int SailBoatMaxEfficiency = 100;
    }
}